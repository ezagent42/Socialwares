...
uv run --no-project agent/flow/evolve_session_diagnose/scripts/diagnose.py --data-dir .runtime/data --commitment .runtime/commitment.yaml
...
```bash
uv run --no-project agent/flow/evolve_session_diagnose/scripts/diagnose.py \
